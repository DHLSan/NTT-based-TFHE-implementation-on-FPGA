...
class FFT_Processor_nayuki {
    ...
    void execute_reverse_int(uint64_t* res, const IntPolynomial* a);
    void execute_reverse_torus32(uint64_t* res, const TorusPolynomial* a);
    void execute_direct_torus32(TorusPolynomial* res, uint64_t* a);
